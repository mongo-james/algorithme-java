...
public static void TrouverSolution (PSeidel p) {
	 double d = 1;
	while (d>E) {
		cpt ++;
...
public static void AfficheSolution(PSeidel p) {
	 for (int i=0;i<=p.A.length-1;i++) {
